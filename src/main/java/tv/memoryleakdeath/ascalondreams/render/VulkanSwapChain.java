...
public class VulkanSwapChain {
   ...
   private long id;
   private static VulkanSwapChain vulkanSwapChain;

   private VulkanSwapChain(VulkanWindow window, int bufferingSetup, boolean vsync) {
      this.device = DeviceManager.getDevice();
      VulkanSurface surface = VulkanSurface.getInstance();
   ...
   public static VulkanSwapChain createInstance(VulkanWindow window, int bufferingSetup, boolean vsync) {
      vulkanSwapChain = new VulkanSwapChain(window, bufferingSetup, vsync);
      return vulkanSwapChain;
   }

   public static VulkanSwapChain getInstance() {
      return vulkanSwapChain;
   }
